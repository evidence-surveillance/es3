...
def plot_trials(trials, page, review_id=None, title=None, sess_id=None):
    ...
    socketio.emit('page_content',
                  {'section': 'plot', 'data': test_bokeh(clusters), 'page': page, 'review_id': review_id,
...
def test_bokeh(matrices):
    ...
    p.image_url(url=['static/images/tsne' + LATEST_DATE + '_sml.png'], x=xlim[0] - 2.0, y=ylim[1],
                w=ylim[1] - ylim[0] - 2.7, h=(xlim[1] - xlim[0]) + 6.7, anchor="top_left")
